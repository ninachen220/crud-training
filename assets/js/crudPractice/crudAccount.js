        ...
        buttons: [
          {
            ...
            action: function(dialogItself) {
              ...
              var form = $('<form></form>');
              // 設定表格送出方法及位置
              form.attr({ method: 'POST', action: self._ajaxUrls.exportApi });
              // 製造當前頁碼input
              ...
              // 製造顯示筆數input
              var lengthMenu_input = $('<input>', {
                type: 'text',
                name: 'length',
                value: lengthMenu,
              }).prop('outerHTML');
              // 放入表格
              form.append(lengthMenu_input);
              // 製造排序方式input
              var order_input = $('<input>', {
                type: 'text',
                name: 'order',
                value: order[1],
              }).prop('outerHTML');
